...
HEAD;
	...
	function add($post) {
		...
		if (empty($server_name)) return false;
...
HTML;
	...
	function printForm($data = '', $action = 'add') {
		...
		$server_id = 0;
		$server_name = $server_groups = $server_type = null;
