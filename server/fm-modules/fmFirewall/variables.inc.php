...
$__FM_CONFIG['fmFirewall'] = array(
		'version'							=> '1.1',
		'client_version'					=> '1.1',
		'description'						=> __('Managing software firewalls should not be difficult. Manage one or more software firewall servers (iptables, ipfw, ipf, pf) through a web interface rather than configuration files individually.'),
		'prefix'							=> 'fw_',
