...
if (isset($__FM_CONFIG['module']['path'])) {
	$__FM_CONFIG['module']['icons']['action']['pass']		= sprintf('<span class="tooltip-right" data-tooltip="%s"><i class="fa fa-arrow-up __action__" aria-hidden="true"></i></span>', __('Pass the packet'));
	$__FM_CONFIG['module']['icons']['action']['block']		= sprintf('<span class="tooltip-right" data-tooltip="%s"><i class="fa fa-times __action__" aria-hidden="true"></i></span>', __('Block the packet'));
	$__FM_CONFIG['module']['icons']['action']['reject']		= sprintf('<span class="tooltip-right" data-tooltip="%s"><i class="fa fa-times __action__" aria-hidden="true"></i></span>', __('Reject the packet'));
	$__FM_CONFIG['module']['icons']['action']['log']		= sprintf('<span class="tooltip-right" data-tooltip="%s"><i class="fa fa-file-text-o __action__" aria-hidden="true"></i></span>', __('Log the packet'));
	$__FM_CONFIG['module']['icons']['negated']				= sprintf('<span class="tooltip-right" data-tooltip="%s"><i class="fa fa-exclamation-circle block" aria-hidden="true"></i></span>', __('Negated'));
	$__FM_CONFIG['module']['icons']['search']				= sprintf('<a href="#" class="global-search tooltip-bottom"><span class="tooltip-right" data-tooltip="%1$s"><i class="fa fa-search preview" alt="%1$s" title="%1$s" aria-hidden="true"></i><span></a>', __('Global Search'));
}
