...
$__FM_CONFIG['module']['icons']['action']['disabled']	= '<img src="fm-modules/' . $_SESSION['module'] . '/images/__action___d.png" border="0" alt="__Action__ (' . _('disabled') . ')" title="__Action__ (' . _('disabled') . ')" width="12" />';
...
$__FM_CONFIG['tcp_flags']				= array('URG' => 1, 'ACK' => 2, 'PSH' => 4,
												'RST' => 8, 'SYN' => 16, 'FIN' => 32);
/** Weekdays */
$__FM_CONFIG['weekdays']				= array(_('Mon') => 1, _('Tue') => 2, _('Wed') => 4,
												_('Thu') => 8, _('Fri') => 16, _('Sat') => 32, _('Sun') => 64);
/** Policy options */
$__FM_CONFIG['fw']['policy_options']	= array(
											'log' => array(
												'bit' => 1,
												'desc' => _('Log packets processed by this rule')
											),
											'established' => array(
												'bit' => 2,
												'desc' => _('Established connection packets')
											),
											'frag' => array(
												'bit' => 4,
												'desc' => _('Matches packets that are fragments and not the first fragment of an IP datagram')
											)
										);
...
$__FM_CONFIG['fw']['notes'] 			= array(
												'iptables' => _('Rules are evaluated on a first-match basis and everything that isn\'t explicitly blocked will be passed by default. So make sure you take care with your rule order.'),
												'pf' => _('Rules are evaluated on a last-match basis and everything that isn\'t explicitly blocked will be allowed by default. So make sure you take care with your rule order.'),
												'ipfw' => _('Rules are evaluated on a first-match basis and everything that isn\'t explicitly passed will be blocked by default. So make sure you take care with your rule order.'),
												'ipfilter' => _('Rules are evaluated on a first-match basis and everything that isn\'t explicitly blocked will be passed by default. So make sure you take care with your rule order.')
											);
