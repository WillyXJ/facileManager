...
if (!function_exists('installfmFirewallSchema')) {
	...
	`policy_source` text,
	`policy_source_translated` text,
	`policy_destination_not` enum('','!') NOT NULL DEFAULT '',
	`policy_destination` text,
	`policy_destination_translated` text,
	`policy_services_not` enum('','!') NOT NULL DEFAULT '',
	`policy_services` text,
	`policy_services_translated` text,
	`policy_snat_type` enum('static','hide') NOT NULL DEFAULT 'static',
	`policy_nat_bidirectional` enum('yes','no') NOT NULL DEFAULT 'no',
	`policy_time` text,
	`policy_uid` text,
	`policy_options` int(3) NOT NULL DEFAULT '0',
	`policy_tcp_flags` varchar(5) DEFAULT NULL,
