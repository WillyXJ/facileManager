...
CREATE TABLE IF NOT EXISTS $database.`fm_{$__FM_CONFIG[$module]['prefix']}policies` (
  ...
  `policy_action` enum('pass','block','reject') NOT NULL,
  `policy_source_not` enum('0','1') NOT NULL,
  `policy_source` text,
  `policy_destination_not` enum('0','1') NOT NULL,
  `policy_destination` text,
  `policy_services_not` enum('0','1') NOT NULL,
