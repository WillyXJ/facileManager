...
if (!defined('PERM_FW_BUILD_SERVER_CONFIGS'))		define('PERM_FW_BUILD_SERVER_CONFIGS', 4);
if (!defined('PERM_FW_OBJECT_MANAGEMENT'))			define('PERM_FW_OBJECT_MANAGEMENT', 8);
if (!defined('PERM_FW_SERVICE_MANAGEMENT'))			define('PERM_FW_SERVICE_MANAGEMENT', 16);
if (!defined('PERM_FW_TIME_MANAGEMENT'))			define('PERM_FW_TIME_MANAGEMENT', 32);
...
if (isset($_SESSION['user']['module_perms'])) {
	...
	$allowed_to_build_configs = ($_SESSION['user']['module_perms']['perm_value'] & PERM_FW_BUILD_SERVER_CONFIGS) || ($_SESSION['user']['fm_perms'] & PERM_FM_SUPER_ADMIN);
