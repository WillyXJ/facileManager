...
/** Handle bulk actions */
	...
	echo $result . buildPopup('footer', _('OK'), array('cancel_button' => 'cancel'), getMenuURL('Servers'));

/** Handle mass updates */
} elseif (is_array($_POST) && array_key_exists('action', $_POST) && $_POST['action'] == 'process-all-updates') {
	echo buildPopup('header', _('Updates Results'));
	$result = "<pre>\n";
	...
	echo $result . buildPopup('footer', _('OK'), array('cancel_button' => 'cancel'));
