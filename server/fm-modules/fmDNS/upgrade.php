...
function upgradefmDNSSchema($module_name) {
	...
	$success = version_compare($running_version, '2.1.1', '<') ? upgradefmDNS_211($__FM_CONFIG, $running_version) : true;
...
/** 2.1.1 */
function upgradefmDNS_211($__FM_CONFIG, $running_version) {
	global $fmdb, $module_name;
	...
	setOption('version', '2.1.1', 'auto', false, 0, $module_name);
