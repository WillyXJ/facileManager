...
CREATE TABLE IF NOT EXISTS $database.`fm_{$__FM_CONFIG[$module]['prefix']}records` (
  ...
  `record_type` enum('A','AAAA','CERT','CNAME','DHCID','DLV','DNAME','DNSKEY','DS','HIP','IPSECKEY','KEY','KX','MX','NAPTR','NS','NSEC','NSEC3','NSEC3PARAM','PTR','RSIG','RP','SIG','SRV','SSHFP','TA','TKEY','TLSA','TSIG','TXT','HINFO') NOT NULL DEFAULT 'A',
