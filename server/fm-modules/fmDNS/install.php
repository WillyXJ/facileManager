...
('options', 'ixfr-from-differences', '( yes | no | primary | master | secondary | slave )', 'no', 'OVZ', 'PS', 'yes', NULL),
...
('options', 'masterfile-style', '( relative | full )', 'no', 'OZ', 'PS', 'no', '9.11.0'),
...
('options', 'notify', '( yes | no | explicit | master-only )', 'no', 'OVZ', 'PS', 'yes', NULL),
